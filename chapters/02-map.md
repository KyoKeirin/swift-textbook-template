...
## この章で学ぶこと
この章では、SwiftUI と MapKit を使って、現在地を中心に周辺施設を検索して、地図に表示する方法を学んだ。さらに、さまざまのコンストラクターの役割や使い方法を学んだ。
...
SwiftUIで現在地を取得して、地図に表示し、周辺施設を検索するアプリである。
...
1. **質問：**
   Swift言語の「MKCoordinateRegion」って何？
   
   **得られた理解：**
   地図の中心と表示範囲である。
   「center」: 地図の中心座標
   「span」: どのくらい広い範囲を表示するか？
2. **質問：**
   「CLLocationCoordinate2D」って何？
